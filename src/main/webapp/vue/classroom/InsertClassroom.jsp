...
<body>
 <h1 class="copy">Rentrer les informations concernant la salle :</h1>
    <form action="/ProjetFilRouge/InsertedClassroom?inserted=true" method=post>
        <!-- Input field for name -->
        <label for="nom">Nom : </label>
        <input id="nom" name="nom" pattern=".{2,}" required>
        ...
        <input id="statut" name="statut" pattern=".{2,}" required>
